...
{
    public partial class FormRegroupementClientParVille : Form
    {
        public FormRegroupementClientParVille()
        {
            InitializeComponent();
        }

        private void FormRegroupementClientParVille_Load(object sender, EventArgs e)
        {
